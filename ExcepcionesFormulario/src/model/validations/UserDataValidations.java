...
public class UserDataValidations {
    ...
    public static boolean checkId(int typeDoc, String id) {
        ...
        if (id.length() != 9) {
            System.out.println("Debe tener 9 elementos.");
            return idOk;
        }
        ...
        if (!isNumeric(substring)) {
            System.out.println("Los primeros ocho caracteres deben ser numeros.");
            return idOk;
        }
        ...
        if (lastChar == expectedChar) {
            ...
            System.out.println("ID no valido. La letra no coincide.");
        }
    ...
    public static boolean checkFormatDate(String date) {
        ...
        int day = Integer.parseInt(separado[0]);
        int month = Integer.parseInt(separado[1]);
        int year = Integer.parseInt(separado[2]);
